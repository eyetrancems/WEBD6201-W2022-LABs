...
{
    /**
     * AuthGuard function that forwards user to Login page if user not logged in visiting protected routes list 
     * @returns {void}
     */
    ...
    /**
     * Load Link function  pushState to to link highlights current page in navbar and
     * 
     * @param link string for pushState
     * @param data string for pushState
     * @returns {void}
     */
    ...
    /**
     * Create Navigation Links on all 'a' HTML elements
     * @returns {void}
     */
    ...
    /**
     * Add link event to 'a' text on page
     * 
     * @param link string to make a link
     * @returns {void}
     */
    ...
    /**
     * Loads the 'content' HTML page based on router
     * 
     * @returns {void}
     */
    ...
    /**
     * Display Home Page with button link to about page
     * 
     * @returns {void}
     */
    ...
    /**
     * Contact Form validation of three fields 
     * @returns {void}
     */
    ...
    /**
     * Display Contact Page that calls ContactFormValidation and creates contact object
     * @returns {void}
     */
    ...
    /**
     * Displays ContactList Page with contact objects in local storage to edit or delete
     * 
     * @returns {void}
     */
    ...
    /**
     * Display Task-List page and loads DisplayTaskList function that adds task and displays task to edit/delete
     * 
     * @returns {void}
     */
    ...
    /**
     * Check Login function that checks if user is logged in to appropiately show login status in nav bar and redirect to login if select log out
     * 
     * @returns {void}
     */
    ...
    /**
     * Display Login Page for Login event
     * 
     * @returns {void}
     */
